...
A FastMCP server providing tools to interact with Denodo AI SDK through natural language queries.
...
mcp = FastMCP(
    name="denodo",
    instructions=f"""
    Denodo AI SDK Interface for natural language database queries.
    
    This server provides access to your database through natural language queries
    using the Denodo AI SDK at {AI_SDK_ENDPOINT}.
    
    Available capabilities:
    - Query database data using natural language
...
async def get_server_info() -> dict:
    ...
    return {
        ...
        "description": "Natural language database interface via Denodo AI SDK",
        "denodo_ai_sdk": {
