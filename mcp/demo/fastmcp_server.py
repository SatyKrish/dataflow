...
A demonstration MCP server providing general purpose AI tools with synthetic data 
generation capabilities using Azure OpenAI through FastMCP.
...
mcp = FastMCP(
    name="demo",
    instructions="""
    Demo AI Assistant providing general purpose AI tools with synthetic data generation capabilities.
...
async def get_server_info() -> dict:
    ...
    return {
        ...
        "description": "General purpose AI tools with synthetic data generation",
